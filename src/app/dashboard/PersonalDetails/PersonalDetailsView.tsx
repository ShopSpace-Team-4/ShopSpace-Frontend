...
import { Home, Search, Pencil, CheckCircle2, User, Bell } from "lucide-react";
...
interface PersonalDetailsViewProps {
  ...
  onToggleNotification: (
    key: keyof PersonalDetailsViewProps["notifications"],
  ) => void;
      ...
      <div className="max-w-4xl">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-sm text-slate-500">
              Manage your profile, identity, and account settings
            </p>
          </div>
          <button
            onClick={onSave}
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                onChange={onChange}
                className="w-full px-3 py-2.5 rounded-lg bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm text-slate-700"
              />
            </div>
            ...
            <div className="flex flex-col gap-1.5 md:col-span-2 mt-2">
              ...
              <textarea
                ...
                onChange={onChange}
                rows={3}
                className="w-full px-3 py-2.5 rounded-lg bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm text-slate-700 resize-none"></textarea>
              <span className="text-[10px] text-slate-400">
                Shown publicly on your landlord profile
              </span>
            </div>
          </form>
        </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center justify-between pb-6 border-b border-slate-100">
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Booking requests, messages, and reports sent to your email
                </p>
              </div>
              <button
                ...
                <span
                  className={`absolute top-1 left-1 bg-white w-4 h-4 rounded-full transition-transform ${notifications.email ? "translate-x-5" : ""}`}
                />
              </button>
            </div>
            ...
            <div className="flex items-center justify-between pb-6 border-b border-slate-100">
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Urgent alerts and one-time codes via Whatsapp
                </p>
              </div>
              <button
                ...
                <span
                  className={`absolute top-1 left-1 bg-white w-4 h-4 rounded-full transition-transform ${notifications.whatsapp ? "translate-x-5" : ""}`}
                />
              </button>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                <span
                  className={`absolute top-1 left-1 bg-white w-4 h-4 rounded-full transition-transform ${notifications.inApp ? "translate-x-5" : ""}`}
                />
              </button>
            </div>
          </div>
        ...
        <div className="bg-red-50/30 rounded-xl border border-red-200 p-6">
          ...
          <p className="text-xs text-red-500/80 mb-4">
            Permanently delete your account and all associated listings. This
