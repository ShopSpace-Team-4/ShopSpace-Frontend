        ...
        <div className="bg-white rounded-xl border border-slate-200 mb-6 p-6">
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
            <div className="flex flex-col gap-1.5">
              ...
              <input type="text" name="firstName" value={formData.firstName} onChange={onChange} className="w-full px-3 py-2.5 rounded-lg bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm text-slate-700" />
            </div>
            
            <div className="flex flex-col gap-1.5">
              <label className="text-[10px] font-bold text-slate-500 tracking-wider uppercase">Last Name</label>
              <input type="text" name="lastName" value={formData.lastName} onChange={onChange} className="w-full px-3 py-2.5 rounded-lg bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm text-slate-700" />
            </div>

            <div className="flex flex-col gap-1.5">
              <label className="text-[10px] font-bold text-slate-500 tracking-wider uppercase">Email Address</label>
              <input type="email" name="email" value={formData.email} onChange={onChange} className="w-full px-3 py-2.5 rounded-lg bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm text-slate-700" />
            </div>

            <div className="flex flex-col gap-1.5">
              <label className="text-[10px] font-bold text-slate-500 tracking-wider uppercase">Whatsapp Number</label>
              <input type="tel" name="whatsapp" value={formData.whatsapp} onChange={onChange} className="w-full px-3 py-2.5 rounded-lg bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm text-slate-700" />
            </div>

            <div className="flex flex-col gap-1.5">
              <label className="text-[10px] font-bold text-slate-500 tracking-wider uppercase">National ID</label>
              <input type="text" name="nationalId" value={formData.nationalId} onChange={onChange} className="w-full px-3 py-2.5 rounded-lg bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm text-slate-700" />
              <span className="text-[10px] text-slate-400">Used for identity verification only</span>
            </div>

            <div className="flex flex-col gap-1.5">
              <label className="text-[10px] font-bold text-slate-500 tracking-wider uppercase">City</label>
              <input type="text" name="city" value={formData.city} onChange={onChange} className="w-full px-3 py-2.5 rounded-lg bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm text-slate-700" />
            </div>

            <div className="flex flex-col gap-1.5">
              <label className="text-[10px] font-bold text-slate-500 tracking-wider uppercase">District</label>
              <input type="text" name="district" value={formData.district} onChange={onChange} className="w-full px-3 py-2.5 rounded-lg bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm text-slate-700" />
            </div>

            <div className="flex flex-col gap-1.5 md:col-span-2 mt-2">
              <label className="text-[10px] font-bold text-slate-500 tracking-wider uppercase">Bio</label>
              <textarea name="bio" value={formData.bio} onChange={onChange} rows={3} className="w-full px-3 py-2.5 rounded-lg bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm text-slate-700 resize-none"></textarea>
              <span className="text-[10px] text-slate-400">Shown publicly on your landlord profile</span>
            </div>
          </form>
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 mb-6 p-6">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center justify-between pb-6 border-b border-slate-100">
              ...
              <button onClick={() => onToggleNotification('email')} className={`w-11 h-6 rounded-full transition-colors relative ${notifications.email ? 'bg-blue-600' : 'bg-slate-200'}`}>
            ...
            <div className="flex items-center justify-between pb-6 border-b border-slate-100">
              ...
              <button onClick={() => onToggleNotification('whatsapp')} className={`w-11 h-6 rounded-full transition-colors relative ${notifications.whatsapp ? 'bg-blue-600' : 'bg-slate-200'}`}>
            ...
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => onToggleNotification('inApp')} className={`w-11 h-6 rounded-full transition-colors relative ${notifications.inApp ? 'bg-blue-600' : 'bg-slate-200'}`}>
